  ...
  carena.addFeature("cider.ScrollBars",  function(obj, options, storage) {
    ...
    scrollbarX.dragging = function(node, mouse) {
      var fw         = obj.parent.font.size.width || 7,
          ...
          // factor of: pixels scroll bar can move to the total width
          scrollFactor = ((totalWidth-viewWidth)/(viewWidth-scrollbarX.width)),
          // scrollbar position
      ...
      obj.parent.scrollX = (scrollFactor*scrollPosX);
    }
