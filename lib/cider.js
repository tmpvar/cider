          ...
          for (j=first.y; j<=first.y+lines; j++) {
            ...
            if (lines > 0) {
              ...
              if (j > first.y) {
                ...
                if (last.y !== j) {
                  renderer.context.fillRect(obj.x+obj.style.paddingLeft-obj.scrollX,
                                            obj.y+(j*obj.font.size.lineHeight())-obj.scrollY,
              ...
              // First line, render from beginning of selection to the end of the line
                ...
                renderer.context.fillRect(obj.x+obj.style.paddingLeft+firstTextWidth-obj.scrollX,
                                          obj.y+(j*obj.font.size.lineHeight())-obj.scrollY,
