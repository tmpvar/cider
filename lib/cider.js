...
(function(export) {
  ...
  carena.addFeature("cider.Textual",  function(obj, options, storage) {
    ...
    carena.applyProperties(obj, {
      localBounds : function() {
        var width  = obj.style.innerWidth + (obj.font.size.width*2),//obj.totalCols*(),
            height = obj.style.innerHeight + (obj.font.size.lineHeight()*2);// obj.totalRows*(obj.font.size.lineHeight()+1);
  ...
  carena.addFeature("cider.LineNumbers",  function(obj, options, storage) {
    ...
    obj.renderSteps.push(function(renderer) {
      ...
      for (l=lineOffset; l<=(lineOffset+maxLines)&&l<=obj.parent.length; l++) {
       ctx.fillText(l,
