    ...
    carena.applyProperties(obj, {
      render : function(renderer) {
        ...
        var offsetX    = obj.style.paddingLeft || 0,
            ...
            visLines   = Math.ceil(obj.style.innerHeight/safe.font.size)-1;
    ...
    carena.applyProperties(obj, {
      show : function (renderer) {
        if (obj.hasFocus !== false && obj.parent.hasFocus !== false) {
          ...
          var visLines = Math.ceil(obj.parent.style.innerHeight/charHeight)-2;
          ...
          var posx   = obj.parent.x + obj.parent.style.paddingLeft,
              posy   = obj.parent.y + obj.parent.style.paddingTop + pos.row * charHeight,
              currentPosition,
          ...
          if (length > 0) {
            ...
            if (tWidth > obj.parent.style.innerWidth) {
              posx = obj.parent.style.innerWidth
                       + obj.parent.x + obj.parent.style.paddingLeft;
            }
          }
          ctx.save();
